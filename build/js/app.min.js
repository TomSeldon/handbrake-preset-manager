...
hpm.categories.list.Ctrl.prototype.createCategory=function(){var a=this.categoriesService.createCategory();a.beingEdited=!0;this.categoryList.splice(0,0,a)};hpm.presets={};hpm.presets.create={};hpm.presets.create.Ctrl=function(a,b,c){this.scope=a;this.presetsService=b;this.categories=[{name:"test"},{name:"another category"}];this.preset=c;this.scope.$on("$destroy",this._destroy.bind(this))};hpm.presets.create.Ctrl.$inject=["$scope","PresetsService","preset"];hpm.presets.create.Ctrl.prototype._destroy=function(){"Added"===this.preset.entityAspect.entityState.name===!0&&this.preset.entityAspect.setDeleted()};
