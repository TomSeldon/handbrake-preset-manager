...
hpm.presets.create.module.configuration.$inject=["$stateProvider","$urlRouterProvider"];hpm.presets.create.module.controller("PresetsCreateCtrl",hpm.presets.create.Ctrl).config(hpm.presets.create.module.configuration);hpm.breeze={};hpm.breeze.entitymanager={};hpm.breeze.entitymanager.Service=function(a,b){this.breeze=a;this.config=b;this.manager=null;this.metadataStore=new a.MetadataStore;this.api={createManager:this.createManager,getSharedManager:this.getManager};return this.exposeApi()};hpm.breeze.entitymanager.Service.$inject=["breeze","config"];hpm.breeze.entitymanager.Service.prototype.exposeApi=function(){for(var a in this.api)this.api.hasOwnProperty(a)&&(this.api[a]=this.api[a].bind(this));return this.api};
hpm.breeze.entitymanager.Service.prototype.createManager=function(){return new this.breeze.EntityManager({serviceName:this.config.breeze.serviceName,metadataStore:this.metadataStore})};hpm.breeze.entitymanager.Service.prototype.getManager=function(){this.manager||(this.manager=this.createManager());return this.manager};hpm.breeze.namingconvention={};hpm.breeze.namingconvention.Factory=function(a){var b=hpm.breeze.namingconvention.Factory.propertyMap;return{createNamingConvention:function(){return new a.NamingConvention({serverPropertyNameToClient:function(a){var d=b.serverToClient;return d.hasOwnProperty(a)?d[a]:a},clientPropertyNameToServer:function(a){var d=b.clientToServer;return d.hasOwnProperty(a)?d[a]:a}})}}};hpm.breeze.namingconvention.Factory.$inject=["breeze"];
hpm.breeze.namingconvention.Factory.propertyMap={serverToClient:{_id:"id"},clientToServer:{id:"_id"}};hpm.config={};hpm.config.Service=function(a){this.toastr={timeOut:5E3,extendedTimeOut:3E3,positionClass:"toast-bottom-right",closeButton:!0,closeHtml:'<i class="black close icon"></i>',toastClass:"toast ui segment",titleClass:"ui tiny header",iconClasses:{success:"green",info:"teal",error:"red",warning:"orange tertiary"}};this.breeze={server:"Express",serviceRoot:a.location.protocol+"//"+a.location.host+"/",serviceName:"breeze/hpm"}};hpm.config.Service.$inject=["$window"];hpm.config.module=angular.module("hpm.config",[]);hpm.config.module.service("config",hpm.config.Service);hpm.breeze.module=angular.module("hpm.breeze",["breeze.angular",hpm.config.module.name]);hpm.breeze.module.configFn=function(){};hpm.breeze.module.runFn=function(a,b){a.config.initializeAdapterInstance("dataService","mongo",!0)};hpm.breeze.module.runFn.$inject=["breeze","namingConventionFactory"];hpm.breeze.module.config(hpm.breeze.module.configFn).run(hpm.breeze.module.runFn).factory("namingConventionFactory",hpm.breeze.namingconvention.Factory).service("entityManagerFactory",hpm.breeze.entitymanager.Service);hpm.data={};hpm.data.Service=function(a,b){this.breeze=a;this.entityManager=b.getSharedManager();this.lookups={};this.initialized=!1;this.api={initialize:this.initialize,createQuery:this.createQuery,getLookups:this.getLookups,getPresets:this.getPresets,getCategories:this.getCategories,createPreset:this.createPreset,createCategory:this.createCategory,cancelAllChanges:this.cancelAllChanges,saveChanges:this.saveChanges,hasChanges:this.hasChanges,hasFetchedMetadata:this.hasFetchedMetadata};return this.exposeApi()};
hpm.data.Service.$inject=["breeze","entityManagerFactory"];hpm.data.Service.prototype.exposeApi=function(){for(var a in this.api)this.api.hasOwnProperty(a)&&(this.api[a]=this.api[a].bind(this));return this.api};hpm.data.Service.prototype.initialize=function(){var a;if(!0===this.initialized)throw Error("Data context initialization attempted multiple times.");a=this.createQuery().from("Lookups");return this.entityManager.executeQuery(a).then(function(a){this.lookups=a.results;this.initialized=!0}.bind(this))};
hpm.data.Service.prototype.createQuery=function(){return new this.breeze.EntityQuery};hpm.data.Service.prototype.getLookups=function(){return this.lookups};hpm.data.Service.prototype.getPresets=function(a){a=a||this.createQuery().from("Presets");return this.entityManager.executeQuery(a)};hpm.data.Service.prototype.getCategories=function(a){a=a||this.createQuery().from("Categories");return this.entityManager.executeQuery(a)};
hpm.data.Service.prototype.getPresetsFromCache=function(a){a=a||this.createQuery();return this.entityManager.executeQueryLocally(a)};hpm.data.Service.prototype.createPreset=function(){return this.entityManager.createEntity("Preset")};hpm.data.Service.prototype.createCategory=function(){return this.entityManager.createEntity("Category")};hpm.data.Service.prototype.saveChanges=function(){return this.entityManager.saveChanges()};hpm.data.Service.prototype.cancelAllChanges=function(){return this.entityManager.cancelChanges()};
hpm.data.Service.prototype.hasChanges=function(){return this.entityManager.hasChanges()};hpm.data.Service.prototype.hasFetchedMetadata=function(){return this.entityManager.metadataStore.hasMetadataFor(this.entityManager.serviceName)};hpm.data.module=angular.module("hpm.data",[hpm.breeze.module.name]);hpm.data.module.service("DataContext",hpm.data.Service);hpm.categories.list.module=angular.module("categories.list",["ui.router",hpm.data.module.name]);hpm.categories.list.module.configuration=function(a){a.state("categories.list",{url:"",views:{"":{templateUrl:"/states/categories/list/list.jade",controller:"CategoriesListCtrl as categories"},"tabledata@categories.list":{templateUrl:"/states/categories/list/table.jade"},"menu@categories.list":{templateUrl:"/states/categories/list/toolbar.jade"}}})};hpm.categories.list.module.configuration.$inject=["$stateProvider"];
